          ...
          <div className="row">
            <div className="col-md-5">
              <div className="home__gallery__content mt-4">
                <p className="text-white font-harmond h1 text-uppercase">
                  Photo Gallery
                </p>
                <p className="text-gray font-inter">
                  If you are looking for an authentic café in Zelzate, Café
                  Regina is the right place for you! Be inspired by the
                  atmospheric photos on this page. This gives you a taste of
